...
---@field calculate? fun(self: Spectrallib.BonusEffect|table, card: Card|table, eff_table: table, context: CalcContext) Calculates effects based on parameters in `context`. See [SMODS calculation](https://github.com/Steamodded/smods/wiki/calculate_functions) docs for details. 
---@field loc_vars? fun(self: Spectrallib.BonusEffect|table, info_queue: table, card: table|{ability: table}, eff_table: table) Provides simple control over displaying descriptions and tooltips of the card. See [`loc_vars`](https://github.com/Steamodded/smods/wiki/Localization#loc_vars) documentation for return value details.<br>Note that `card` is often not a `Card` object. 
