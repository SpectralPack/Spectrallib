...
---@field calculate? (fun(self: Spectrallib.BonusEffect|table, card: Card|table, eff_table: table, context: CalcContext|table): any) Calculates effects based on parameters in `context`. See [SMODS calculation](https://github.com/Steamodded/smods/wiki/calculate_functions) docs for details. 
